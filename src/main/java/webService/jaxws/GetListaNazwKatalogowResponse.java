...
@XmlRootElement(name = "getListaNazwKatalogowResponse", namespace = "http://webService/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getListaNazwKatalogowResponse", namespace = "http://webService/")

public class GetListaNazwKatalogowResponse {
